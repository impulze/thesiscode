...
/** Construction of the class CncDriveType.
...
: CncDriveTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
CncDriveType::CncDriveType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncDriveTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class CncDriveType with all components.
*/
CncDriveType::CncDriveType(
...
: CncDriveTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncDriveType::createTypes()
{
    // Call base class
    CncDriveTypeBase::createTypes();
...
*/
void CncDriveType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncDriveTypeBase::clearStaticMembers();
}
