...
#ifndef __OPCUACNC_CNCAXISLISTTYPE_H__
#define __OPCUACNC_CNCAXISLISTTYPE_H__
...
/** @brief Class implementing the UaObject interface for the CncAxisListType.
 *
 ...
 *
 */
class UAMODELS_EXPORT CncAxisListType:
    public CncAxisListTypeBase
{
    UA_DISABLE_COPY(CncAxisListType);
protected:
    // destruction
    virtual ~CncAxisListType();
public:
    // construction
    CncAxisListType(const UaNodeId& nodeId, UaObject* pInstanceDeclarationObject, NodeManagerConfig* pNodeConfig, UaMutexRefCounted* pSharedMutex = NULL);
    CncAxisListType(const UaNodeId& nodeId, const UaString& name, OpcUa_UInt16 browseNameNameSpaceIndex, NodeManagerConfig* pNodeConfig, UaMutexRefCounted* pSharedMutex = NULL);
    CncAxisListType(
...
#endif // #ifndef __OPCUACNCCNCAXISLISTTYPE_H__
