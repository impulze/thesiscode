...
#include "thesiscnc_nodemanagertcnc.h"
...
/** Construction of the class NodeManagerTCNC.
 */
NodeManagerTCNC::NodeManagerTCNC(
...
: NodeManagerTCNCBase(firesEvents, nHashTableSize)
{
}

/** Destroys the NodeManagerTCNC object and all nodes managed by the node manager
 */
NodeManagerTCNC::~NodeManagerTCNC()
{
}
 ...
 */
UaStatus NodeManagerTCNC::afterStartUp()
{
    // The address space is created by the base class
    UaStatus ret = NodeManagerTCNCBase::afterStartUp();
...
*/
UaStatus NodeManagerTCNC::beforeShutDown()
{
    UaStatus ret;
    return ret;
}
