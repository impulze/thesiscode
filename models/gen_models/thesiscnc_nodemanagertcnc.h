...
#ifndef _THESISCNC_NODEMANAGERTCNC_H__
#define _THESISCNC_NODEMANAGERTCNC_H__
...
/** NodeManager for TCNC information model.
 *
 *  This class is used to add custom implementation.
 *  The base class NodeManagerTCNCBase contains the auto generated code for creating the adress space.
 */
class UAMODELS_EXPORT NodeManagerTCNC : public NodeManagerTCNCBase
{
    UA_DISABLE_COPY(NodeManagerTCNC);
    NodeManagerTCNC();
public:
    /* construction / destruction */
    NodeManagerTCNC(OpcUa_Boolean firesEvents, OpcUa_Int32 nHashTableSize = 10007);
    virtual ~NodeManagerTCNC();
...
#endif // #ifndef __NODEMANAGERTCNC_H__
