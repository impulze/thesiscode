...
/** Construction of the class CncAxisType.
...
: CncAxisTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
CncAxisType::CncAxisType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncAxisTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class CncAxisType with all components.
*/
CncAxisType::CncAxisType(
...
: CncAxisTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncAxisType::createTypes()
{
    // Call base class
    CncAxisTypeBase::createTypes();
...
*/
void CncAxisType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncAxisTypeBase::clearStaticMembers();
}
