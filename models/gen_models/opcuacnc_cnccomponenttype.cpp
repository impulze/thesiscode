...
/** Construction of the class CncComponentType.
 ...
 */
CncComponentType::CncComponentType(
...
: CncComponentTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
CncComponentType::CncComponentType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncComponentTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class CncComponentType with all components.
*/
CncComponentType::CncComponentType(
...
: CncComponentTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncComponentType::createTypes()
{
    // Call base class
    CncComponentTypeBase::createTypes();
...
*/
void CncComponentType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncComponentTypeBase::clearStaticMembers();
}
