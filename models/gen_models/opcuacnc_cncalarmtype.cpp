...
/** Construction of the class CncAlarmType.
...
: CncAlarmTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, sourceNode, sourceName, pSharedMutex)
{
}
...
CncAlarmType::CncAlarmType(
    ...
    const UaString& sourceName,      //!< [in] Name of the source used for this condition object
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncAlarmTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, sourceNode, sourceName, pSharedMutex)
{
}

/**  Constructs an instance of the class CncAlarmType with all components.
*/
CncAlarmType::CncAlarmType(
...
: CncAlarmTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncAlarmType::createTypes()
{
    // Call base class
    CncAlarmTypeBase::createTypes();
...
*/
void CncAlarmType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncAlarmTypeBase::clearStaticMembers();
}
