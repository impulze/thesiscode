...
#ifndef __THESISCNC_DATATYPES_H__
#define __THESISCNC_DATATYPES_H__
...
#define THESISCNC_EXTENSIONOBJECT_GET_ENCODEABLE(xExpectedType, xExtensionObject) \
    (ThesisCNC_##xExpectedType*)((((xExtensionObject)->Encoding == OpcUa_ExtensionObjectEncoding_EncodeableObject && \
    (xExtensionObject)->Body.EncodeableObject.Type != OpcUa_Null && \
    (xExtensionObject)->Body.EncodeableObject.Type->TypeId == ThesisCNCId_##xExpectedType && \
    OpcUa_StrCmpA((xExtensionObject)->Body.EncodeableObject.Type->NamespaceUri, "http://cs.hs-rm.de/mierswa_thesis/CNC/") == 0 && \
...
#endif // __THESISCNC_DATATYPES_H__
