 ...
 *  This class is used to create the nodes defined for the namespace http://cs.hs-rm.de/mierswa_thesis/3AchsenEMCNCLaserSchneid/.
 *
 */
class UAMODELS_EXPORT NodeManagerDemoBase : public NodeManagerBase
{
...
private:
    ...
    UaStatus addObjectsFolderCncInterfaceCncAxisListX(const XmlUaNodeFactoryManager &factory);
    UaStatus addObjectsFolderCncInterfaceCncAxisListY(const XmlUaNodeFactoryManager &factory);
    UaStatus addObjectsFolderCncInterfaceCncAxisListZ(const XmlUaNodeFactoryManager &factory);
    UaStatus addObjectsFolderCncInterfaceCncChannelListChannel1(const XmlUaNodeFactoryManager &factory);
