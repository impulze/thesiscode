...
/** Construction of the class CncAxisListType.
 ...
 */
CncAxisListType::CncAxisListType(
...
: CncAxisListTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
CncAxisListType::CncAxisListType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncAxisListTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class CncAxisListType with all components.
*/
CncAxisListType::CncAxisListType(
...
: CncAxisListTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncAxisListType::createTypes()
{
    // Call base class
    CncAxisListTypeBase::createTypes();
...
*/
void CncAxisListType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncAxisListTypeBase::clearStaticMembers();
}
