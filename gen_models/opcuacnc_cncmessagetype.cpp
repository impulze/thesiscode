...
/** Construction of the class CncMessageType.
...
CncMessageType::CncMessageType(
    ...
    const UaNodeId& sourceNode,      //!< [in] NodeId of the source node used for this condition object. Can be null if the source is not a node in the address space
    const UaString& sourceName,      //!< [in] Name of the source used for this condition object
...
: CncMessageTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, sourceNode, sourceName, pSharedMutex)
{
}
...
CncMessageType::CncMessageType(
    ...
    const UaString& sourceName,      //!< [in] Name of the source used for this condition object
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncMessageTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, sourceNode, sourceName, pSharedMutex)
{
}

/**  Constructs an instance of the class CncMessageType with all components.
*/
CncMessageType::CncMessageType(
...
: CncMessageTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncMessageType::createTypes()
{
    // Call base class
    CncMessageTypeBase::createTypes();
...
*/
void CncMessageType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncMessageTypeBase::clearStaticMembers();
}
