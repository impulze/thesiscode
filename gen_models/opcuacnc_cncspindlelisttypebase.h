/******************************************************************************
** opcuacnc_cncspindlelisttypebase.h
**
**   **************************** auto-generated ****************************
...
#ifndef __OPCUACNC_CNCSPINDLELISTTYPEBASE_H__
#define __OPCUACNC_CNCSPINDLELISTTYPEBASE_H__
...
/** Generated base class for a CncSpindleListType.
 *
 *  This class contains the generated base code for the object type CncSpindleListType
 ...
 *
 *  **Object members of the CncSpindleListType:**
 *
 ...
 *
 */
class UAMODELS_EXPORT CncSpindleListTypeBase:
    public OpcUa::BaseObjectType
{
    UA_DISABLE_COPY(CncSpindleListTypeBase);
protected:
    virtual ~CncSpindleListTypeBase();
public:
    // construction / destruction
    CncSpindleListTypeBase(const UaNodeId& nodeId, UaObject* pInstanceDeclarationObject, NodeManagerConfig* pNodeConfig, UaMutexRefCounted* pSharedMutex = NULL);
    CncSpindleListTypeBase(const UaNodeId& nodeId, const UaString& name, OpcUa_UInt16 browseNameNameSpaceIndex, NodeManagerConfig* pNodeConfig, UaMutexRefCounted* pSharedMutex = NULL);
    CncSpindleListTypeBase(
...
// Add placeholders
    ...
    void useAccessInfoFromInstance(CncSpindleListTypeBase *pInstance);
...
#endif // #ifndef __OPCUACNCCNCSPINDLELISTTYPEBASE_H__
