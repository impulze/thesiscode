...
/** Construction of the class CncChannelType.
...
: CncChannelTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
CncChannelType::CncChannelType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncChannelTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class CncChannelType with all components.
*/
CncChannelType::CncChannelType(
...
: CncChannelTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncChannelType::createTypes()
{
    // Call base class
    CncChannelTypeBase::createTypes();
...
*/
void CncChannelType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncChannelTypeBase::clearStaticMembers();
}
