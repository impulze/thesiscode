/******************************************************************************
** eckelmanncnc_instancefactory_ecnc.cpp
**
**   **************************** auto-generated ****************************
...
#include "eckelmanncnc_instancefactory_ecnc.h"
#include "eckelmanncnc_identifiers.h"
#include "eckelmanncnc_datatypes.h"


namespace EckelmannCNC
{

InstanceFactoryECNC::InstanceFactoryECNC(OpcUa_UInt16 namespaceIndex)
: XmlUaNodeFactoryNamespace(namespaceIndex)
{
}

OpcUa::BaseVariableType* InstanceFactoryECNC::createVariable(
...
OpcUa::BaseObjectType* InstanceFactoryECNC::createObject(
...
/**Returns default values for all data types provided by the Namespace http://cs.hs-rm.de/mierswa_thesis/eckelmann */
UaVariant InstanceFactoryECNC::defaultValue(const UaNodeId &dataTypeId, OpcUa_Int32 valueRank) const
{
