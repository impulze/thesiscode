/******************************************************************************
** opcuacnc_cncspindlelisttype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class CncSpindleListType.
 ...
 */
CncSpindleListType::CncSpindleListType(
...
: CncSpindleListTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
CncSpindleListType::CncSpindleListType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncSpindleListTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class CncSpindleListType with all components.
*/
CncSpindleListType::CncSpindleListType(
...
: CncSpindleListTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncSpindleListType::createTypes()
{
    // Call base class
    CncSpindleListTypeBase::createTypes();
...
*/
void CncSpindleListType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncSpindleListTypeBase::clearStaticMembers();
}
