...
/** Construction of the class NodeManagerCNC.
 */
NodeManagerCNC::NodeManagerCNC(
...
: NodeManagerCNCBase(firesEvents, nHashTableSize)
{
}

/** Destroys the NodeManagerCNC object and all nodes managed by the node manager
 */
NodeManagerCNC::~NodeManagerCNC()
{
}
 ...
 */
UaStatus NodeManagerCNC::afterStartUp()
{
    // The address space is created by the base class
    UaStatus ret = NodeManagerCNCBase::afterStartUp();
...
*/
UaStatus NodeManagerCNC::beforeShutDown()
{
    UaStatus ret;
    return ret;
}
