...
/** Construction of the class CncSpindleType.
...
: CncSpindleTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
CncSpindleType::CncSpindleType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: CncSpindleTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class CncSpindleType with all components.
*/
CncSpindleType::CncSpindleType(
...
: CncSpindleTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void CncSpindleType::createTypes()
{
    // Call base class
    CncSpindleTypeBase::createTypes();
...
*/
void CncSpindleType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    CncSpindleTypeBase::clearStaticMembers();
}
