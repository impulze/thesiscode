/******************************************************************************
** opcuacnc_cncaxislisttypebase.h
**
**   **************************** auto-generated ****************************
...
#ifndef __OPCUACNC_CNCAXISLISTTYPEBASE_H__
#define __OPCUACNC_CNCAXISLISTTYPEBASE_H__
...
/** Generated base class for a CncAxisListType.
 *
 *  This class contains the generated base code for the object type CncAxisListType
 ...
 *
 *  **Object members of the CncAxisListType:**
 *
 ...
 *
 */
class UAMODELS_EXPORT CncAxisListTypeBase:
    public OpcUa::BaseObjectType
{
    UA_DISABLE_COPY(CncAxisListTypeBase);
protected:
    virtual ~CncAxisListTypeBase();
public:
    // construction / destruction
    CncAxisListTypeBase(const UaNodeId& nodeId, UaObject* pInstanceDeclarationObject, NodeManagerConfig* pNodeConfig, UaMutexRefCounted* pSharedMutex = NULL);
    CncAxisListTypeBase(const UaNodeId& nodeId, const UaString& name, OpcUa_UInt16 browseNameNameSpaceIndex, NodeManagerConfig* pNodeConfig, UaMutexRefCounted* pSharedMutex = NULL);
    CncAxisListTypeBase(
...
// Add placeholders
    ...
    void useAccessInfoFromInstance(CncAxisListTypeBase *pInstance);
...
#endif // #ifndef __OPCUACNCCNCAXISLISTTYPEBASE_H__
